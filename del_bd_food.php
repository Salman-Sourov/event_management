<?php
	...
	if(isset($_REQUEST['delete_id']))
	{
		...
		$select_stmt= $db->prepare('SELECT * FROM bd_food WHERE id =:id');	//sql select query
		...
		$delete_stmt = $db->prepare('DELETE FROM bd_food WHERE id =:id');
...
<title>Delete Weeding Food</title>
