<?php
	...
	if(isset($_REQUEST['delete_id']))
	{
		...
		$select_stmt= $db->prepare('SELECT * FROM wd_photography WHERE id =:id');	//sql select query
		...
		$delete_stmt = $db->prepare('DELETE FROM wd_photography WHERE id =:id');
		$delete_stmt->bindParam(':id',$id);
		$delete_stmt->execute();
		
		header("Location:platinumbd.php");
	}
...
<title>Dellete Weeding Photography</title>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM wd_photography");	//sql select query
									$select_stmt->execute();
