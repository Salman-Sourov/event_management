...
<title>Add Gold Corporate</title>
...
<body>	
			<form method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<a href="goldcorpo.php" class="btn btn-success">Customer View</a>
				</div>
				</div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM corpo_gold");	//sql select query
									$select_stmt->execute();
