	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="goldcorpo.php"</script>';
			}
		}
	}
}
...
<html>
	<head>
		<title>Corporate Gold Package</title>
	...
	<body>
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-dark">
		...
		<div class="container">
			<br />
			<span class="section-heading"> Gold Package Details</span><br />
			<br />
...
<span class="section-heading-left">Silver</span>
			<?php
				$no = 1;
				$query = "SELECT * FROM corpo_gold ORDER BY id ASC";
				...
				if(mysqli_num_rows($result) > 0)
				{
					...
					{
			?>			
			<form method="post" action="goldcorpo.php?action=add&id=<?php echo $row["id"]; ?>">
				<div class="col-md-4">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="goldcorpo.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
