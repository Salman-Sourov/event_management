<?php
	...
	if(isset($_REQUEST['delete_id']))
	{
		...
		$select_stmt= $db->prepare('SELECT * FROM bd_stage WHERE id =:id');	//sql select query
		...
		$delete_stmt = $db->prepare('DELETE FROM bd_stage WHERE id =:id');
		$delete_stmt->bindParam(':id',$id);
		$delete_stmt->execute();
		
		header("Location:del_bd_stage.php");
	}
...
<title>Delete Birthday Invitation Card</title>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM bd_stage");	//sql select query
									$select_stmt->execute();
