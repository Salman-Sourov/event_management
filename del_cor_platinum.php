<?php
	...
	if(isset($_REQUEST['delete_id']))
	{
		...
		$select_stmt= $db->prepare('SELECT * FROM corpo_platinum WHERE id =:id');	//sql select query
		...
		header("Location:del_cor_platinum.php");
	}
...
<title>Dellete Corporate Platinum Package</title>
