	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="platinumcorpo.php"</script>';
			}
		}
	}
}
...
<html>
	<head>
		<title>Corporate Platinum Package</title>
	...
	<body>
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-dark">
		...
		<div class="container">
			<br />
			<span class="section-heading"> Platinum Package Details</span><br />
			<br />
			
			
<span class="section-heading-left">Platinum</span>
			<?php
				$no = 1;
				$query = "SELECT * FROM corpo_platinum ORDER BY id ASC";
				...
				if(mysqli_num_rows($result) > 0)
				{
					...
					{
			?>			
			<form method="post" action="platinumcorpo.php?action=add&id=<?php echo $row["id"]; ?>">
				<div class="col-md-4">
					<span class="section-heading-no"><?php echo $no ?></span>
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="platinumcorpo.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
