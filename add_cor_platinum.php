...
if(isset($_REQUEST['btn_insert']))
{
	try
	{
		...
		if(!isset($errorMsg))
		{
			$insert_stmt=$db->prepare('INSERT INTO bd_stage(id,name,details,price,image) VALUES(:fid,:fname,:fdetails,:fprice,:fimage)'); //sql insert query
			...
			if($insert_stmt->execute())
			{
				...
				header("refresh:1;add_bd_stage.php"); //refresh 1 second and redirect to index.php page
			}
		}
	}
...
<title>Add Platinum Corporate</title>
...
<body>	
			<form method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<a href="platinumcorpo.php" class="btn btn-success">Customer View</a>
				</div>
				</div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM corpo_platinum");	//sql select query
									$select_stmt->execute();
