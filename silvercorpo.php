	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="silvercorpo.php"</script>';
			}
		}
	}
}
...
<html>
	<head>
		<title>Corporate Silver Package</title>
...
<span class="section-heading-left">Silver</span>
			<?php
				$no = 1;
				$query = "SELECT * FROM corpo_silver ORDER BY id ASC";
				...
				if(mysqli_num_rows($result) > 0)
				{
					...
					{
			?>			
			<form method="post" action="silvercorpo.php?action=add&id=<?php echo $row["id"]; ?>">
				<div class="col-md-4">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="silvercorpo.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
