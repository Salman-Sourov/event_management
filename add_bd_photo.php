...
if(isset($_REQUEST['btn_insert']))
{
	try
	{
		...
		if(!isset($errorMsg))
		{
			$insert_stmt=$db->prepare('INSERT INTO bd_photography(id,name,details,price,image) VALUES(:fid,:fname,:fdetails,:fprice,:fimage)'); //sql insert query
			...
			if($insert_stmt->execute())
			{
				...
				header("refresh:1;add_bd_photo.php"); 
			}
		}
	}
...
<title>Add Birthday Photography</title>
