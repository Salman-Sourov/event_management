<?php
	...
	if(isset($_REQUEST['delete_id']))
	{
		...
		$select_stmt= $db->prepare('SELECT * FROM wd_stage WHERE id =:id');	//sql select query
		...
		$delete_stmt = $db->prepare('DELETE FROM wd_stage WHERE id =:id');
...
<title>Dellete Weeding Stage</title>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM wd_stage");	//sql select query
									$select_stmt->execute();
