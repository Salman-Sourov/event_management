<?php
	...
	if(isset($_REQUEST['delete_id']))
	{
		...
		$select_stmt= $db->prepare('SELECT * FROM wd_card WHERE id =:id');	//sql select query
		...
		$delete_stmt = $db->prepare('DELETE FROM wd_card WHERE id =:id');
...
<title>Dellete Weeding Invitation Card</title>
