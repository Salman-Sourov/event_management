...
if(isset($_REQUEST['btn_insert']))
{
	try
	{
		...
		if(!isset($errorMsg))
		{
			$insert_stmt=$db->prepare('INSERT INTO bd_food(id,name,details,price,image) VALUES(:fid,:fname,:fdetails,:fprice,:fimage)'); //sql insert query
			...
			if($insert_stmt->execute())
			{
				...
				header("refresh:1;add_bd_food.php");			}
		}
	}
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM bd_food");	//sql select query
									$select_stmt->execute();
