	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="platinumbd.php"</script>';
			}
		}
	}
}
...
<html>
	<head>
		<title>Platinum Birthday Package</title>
	...
	<body>
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-dark">
		...
		<div class="container">
			<br />
			<span class="section-heading">Birthday Platinum Package Details</span><br />
			<br />
<span class="section-heading-left">Stage Design</span>
			<?php
				...
				if(mysqli_num_rows($result) > 0)
				{
					...
					{
			?>			
			<form method="post" action="platinumbd.php?action=add&id=<?php echo $row["id"]; ?>">
				<div class="col-md-4">
...
<span class="section-heading-left">Food</span>
			<?php
				$query = "SELECT * FROM bd_food ORDER BY id ASC";
				$result = mysqli_query($connect, $query);
				if(mysqli_num_rows($result) > 0)
				{
					while($row = mysqli_fetch_array($result))
...
<span class="section-heading-left">Invitation Card</span>
			<?php
				$query = "SELECT * FROM bd_card ORDER BY id ASC";
				$result = mysqli_query($connect, $query);
				if(mysqli_num_rows($result) > 0)
				{
					while($row = mysqli_fetch_array($result))
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="platinumbd.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
