...
<html lang="en">
  <head>
    ...
    <div class="container">
		...
		<span class="section-heading">Add weeding Package</span><br>
		<br>
		<a class="section-heading-pack" href="add_wd_stage.php">Stage design</a>
		<a class="section-heading-pack" href="add_wd_card.php">invitation card</a>
		<a class="section-heading-pack" href="add_wd_photo.php">photography</a>
		<a class="section-heading-pack" href="add_wd_transport.php">transport</a>
		<a class="section-heading-pack" href="add_wd_catering.php">catering</a>
