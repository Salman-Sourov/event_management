<?php
	...
	if(isset($_REQUEST['delete_id']))
	{
		...
		$select_stmt= $db->prepare('SELECT * FROM wd_transport WHERE id =:id');	//sql select query
		...
		$delete_stmt = $db->prepare('DELETE FROM wd_transport WHERE id =:id');
...
<title>Dellete Weeding Transport</title>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM wd_transport");	//sql select query
									$select_stmt->execute();
