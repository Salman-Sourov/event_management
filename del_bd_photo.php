<?php
	...
	if(isset($_REQUEST['delete_id']))
	{
		...
		$select_stmt= $db->prepare('SELECT * FROM bd_photography WHERE id =:id');	//sql select query
		...
		$delete_stmt = $db->prepare('DELETE FROM bd_photography WHERE id =:id');
...
<title>Delete Weeding Photography</title>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM bd_photography");	//sql select query
									$select_stmt->execute();
