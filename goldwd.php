	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="goldwd.php"</script>';
			}
		}
	}
}
...
<span class="section-heading-left">Stage Design</span>
			<?php
				...
				if(mysqli_num_rows($result) > 0)
				{
					...
					{
			?>			
			<form method="post" action="goldwd.php?action=add&id=<?php echo $row["id"]; ?>">
				<div class="col-md-4">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="goldwd.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
